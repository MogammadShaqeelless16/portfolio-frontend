...
import './backgroundAnimation.css'; // Import CSS file
...
function BackgroundAnimation() {
  useEffect(() => {
    ...
    scene3.to("#bg2-grad", { attr: { cy: 600, r: 500 } }, 0);
...
<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" preserveAspectRatio="xMidYMax slice">
    ...
    <rect id="bg" width="750" height="500" fill="url(#bg_grad)" style={{ opacity: 0.8 }} />
  ...
  ); // This component doesn't render anything visible, it's just for animation logic
}
